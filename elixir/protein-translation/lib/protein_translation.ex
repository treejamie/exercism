defmodule ProteinTranslation do
  ...
  - reduce while is very useful.
  - binary pattern matching will silently drop non compatible chunks by design
    for <<codon::binary-size(3) <- r>>, do: codon
    !=
     rna
    |> to_charlist()
    |> Enum.chunk_every(3)
  ...
  - then really is a swiss army knife.
  """
  @codons %{
    "UGU" => "Cysteine",
    "UGC" => "Cysteine",
